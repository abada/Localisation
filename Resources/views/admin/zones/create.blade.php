...
@section('content')
    {!! Form::open(['route' => ['admin.localisation.zone.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-10">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('localisation::admin.zones.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
